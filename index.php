					...
					<div class="row" id="att_row" style="margin-top:15px;">
						<div class="small-3 columns">
							...
							<ul class="stack button-group">
								<li><a name="Technique" class="button">Control / Balance</a></li>
								<li><a name="Technique" class="button">Elevation</a></li>
								<li><a name="Technique" class="button">Turns</a></li>
								<li><a name="Technique" class="button">Arms</a></li>
								<li><a name="Technique" class="button">Hands</a></li>
								<li><a name="Technique" class="button">Extensions</a></li>
								<li><a name="Technique" class="button">Head / Shoulders</a></li>
								<li><a name="Technique" class="button">Body Lines</a></li>
								<li><a name="Technique" class="button">Feet</a></li>
								<li><a name="Technique" class="button">Legs</a></li>
							</ul>
						</div>
						...
						<div class="small-3 columns">
							<h3>Performance</h3>
							<ul class="stack button-group">
								<li><a name="Performance" class="button">Personality</a></li>
								<li><a name="Performance" class="button">Stage Presence</a></li>
								<li><a name="Performance" class="button">Smile</a></li>
								<li><a name="Performance" class="button">Intensity</a></li>
								<li><a name="Performance" class="button">Emotion</a></li>
							</ul>
						</div>
						...
						<div class="small-3 columns">
							...
							<ul class="stack button-group">
								<li><a name="Choreography &amp; Musicality" class="button">Choreography</a></li>
								<li><a name="Choreography &amp; Musicality" class="button">Precision</a></li>
								<li><a name="Choreography &amp; Musicality" class="button">Creativeness</a></li>
								<li><a name="Choreography &amp; Musicality" class="button">Timing</a></li>
								<li><a name="Choreography &amp; Musicality" class="button">Difficulty</a></li>
								<li><a name="Choreography &amp; Musicality" class="button">Use of Space</a></li>
								<li><a name="Choreography &amp; Musicality" class="button">Continuity</a></li>
							</ul>
						</div>
						...
						<div class="small-3 columns">
							...
							<ul class="stack button-group">
								<li><a name="Overall Appearance" class="button">Costume</a></li>
								<li><a name="Overall Appearance" class="button">Confidence</a></li>
								<li><a name="Overall Appearance" class="button">Appearance</a></li>
								<li><a name="Overall Appearance" class="button">Appropriateness</a></li>
							</ul>
						</div>
